...
#define IMX477_SENSOR_I2CID				(0x1A)
#define IMX477_MIPI_CLOCK_FEQ			(450)	//MHz
#define IMX477_MIPI_LANE_CNT			(2)
#define IMX477_MIPI_DPP					(10)	//depth per pixel
#define IMX477_MIPITX_CNTCLK_EN			(1)		//continuous clock output enable
#define IMX477_LANE_NB					(2)
#define SENSORDPLIB_SENSOR_IMX477		(SENSORDPLIB_SENSOR_HM2130)
#define DYNAMIC_ADDRESS

#define IMX477_SENSOR_WIDTH				4056
#define IMX477_SENSOR_HEIGHT			3040
#define IMX477_INP_CROP_WIDTH			4032
#define IMX477_INP_CROP_HEIGHT			3024
#define IMX477_INP_OUT_WIDTH			576
#define IMX477_INP_OUT_HEIGHT			432
#define IMX477_HW2x2_CROP_WIDTH			480
#define IMX477_HW2x2_CROP_HEIGHT		264
#define IMX477_HW5x5_CROP_WIDTH			576
#define IMX477_HW5x5_CROP_HEIGHT		432

#define IMX477_QBC_ADJUST				(0x02)
#define IMX477_REG_BASE_SPC_GAINS_L		(0x7b10)
#define IMX477_REG_BASE_SPC_GAINS_R		(0x7c00)

/* QBC Re-mosaic broken line correction registers */
#define IMX477_LPF_INTENSITY_EN			(0xC428)
#define IMX477_LPF_INTENSITY_ENABLED	(0x00)
#define IMX477_LPF_INTENSITY_DISABLED	(0x01)
#define IMX477_LPF_INTENSITY			(0xC429)
#define IMX477_EXPOSURE_DEFAULT			(0x640)
#define IMX477_EXPOSURE_SETTING			(0xA40)
#define IMX477_AGAIN_SETTING			(0x00)
#define IMX477_DGAIN_SETTING			(0x100)
...
#define CIS_I2C_ID					IMX477_SENSOR_I2CID
 ...
 * DP SENCTRL CFG
 */
#define SENCTRL_SENSOR_TYPE			SENSORDPLIB_SENSOR_IMX477
#define SENCTRL_STREAM_TYPE			SENSORDPLIB_STREAM_NONEAOS
#define SENCTRL_SENSOR_WIDTH 		IMX477_SENSOR_WIDTH
#define SENCTRL_SENSOR_HEIGHT 		IMX477_SENSOR_HEIGHT
 ...
 */
#define DP_INP_SUBSAMPLE			INP_SUBSAMPLE_14TO2_B
#define DP_INP_BINNING				INP_BINNING_DISABLE
#define DP_INP_CROP_START_X			0
#define DP_INP_CROP_START_Y			0
#define DP_INP_CROP_WIDTH          	IMX477_INP_CROP_WIDTH
#define DP_INP_CROP_HEIGHT         	IMX477_INP_CROP_HEIGHT
#define DP_INP_OUT_WIDTH 		    IMX477_INP_OUT_WIDTH
#define DP_INP_OUT_HEIGHT 		    IMX477_INP_OUT_HEIGHT
...
#define DP_HW5X5_CROP_WIDTH 		IMX477_HW5x5_CROP_WIDTH
#define DP_HW5X5_CROP_HEIGHT 		IMX477_HW5x5_CROP_HEIGHT
#define DP_HW5X5_OUT_WIDTH 			IMX477_HW5x5_CROP_WIDTH
#define DP_HW5X5_OUT_HEIGHT 		IMX477_HW5x5_CROP_HEIGHT
