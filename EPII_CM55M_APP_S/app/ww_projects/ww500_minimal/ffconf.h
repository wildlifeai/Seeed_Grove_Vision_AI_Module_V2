/*---------------------------------------------------------------------------/
/  ffconf.h for ww500_minimal
/
/  A copy of the ww500_md configuration, trimmed for a light-weight SD card task:
/  one volume, 8.3 file names, no directories (FF_FS_RPATH 0), and no f_mkfs(), volume
/  labels, string functions, file locking or TRIM. Format the card on a PC.
/  Everything else is as in ww500_md/ffconf.h.
/---------------------------------------------------------------------------*/
