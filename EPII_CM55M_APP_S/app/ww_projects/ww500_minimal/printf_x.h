 ...
 *      Author: charl
 *
 *  Macros to print different colours on an ANSI terminal, and a buffer dump utility.
 *
 *  Copied into ww500_minimal from ww500_md and reformatted. printf_x_test() was left behind
 *  as nothing here uses it.
 */
...
#define XP_WHITE	xprintf("%s", ESC_NONE);		// This is "normal" white
...
#define XP_BR_WHITE	xprintf("%s", ESC_WHITE);		// Bright white
...
/**
 * @brief Prints the contents of a buffer, 16 bytes per line, as hex and ASCII.
 */
